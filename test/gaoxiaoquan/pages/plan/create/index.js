...
Page({
        ...
        success: (res) => {
          ...
          wx.navigateTo({
            ...
            success: () => {
              ...
              wx.removeStorageSync('listField')
            }
          })
  ...
  onShow: function () {
    ...
    var listText = (wx.getStorageSync('listField') == "")?"":wx.getStorageSync('listField')[0].text;
    var planList = (wx.getStorageSync('listField') == "") ?[] : wx.getStorageSync('listField');
